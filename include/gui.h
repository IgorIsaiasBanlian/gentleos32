...
enum {
    ...
    COLOR_WIDGET_A_BG = 0x05,
    COLOR_WIDGET_A_FG = COLOR_WIDGET_FG,
    COLOR_TITLE_A_BG = COLOR_WIDGET_A_BG,
    COLOR_TITLE_A_FG = COLOR_WIDGET_FG,
    COLOR_ALERT_FG = 0x0d,
    COLOR_BORDER = COLOR_WIDGET_FG,
    COLOR_DESKTOP = COLOR_WIDGET_A_BG,
    COLOR_DESKTOP_ALT = 0,
...
enum {
    ...
    COLOR_WIDGET_A_BG = 0x08,
    COLOR_WIDGET_A_FG = COLOR_WIDGET_FG,
    COLOR_TITLE_A_BG = 0x0e,
    COLOR_TITLE_A_FG = COLOR_WIDGET_FG,
    COLOR_ALERT_FG = 0x04,
    COLOR_BORDER = COLOR_WIDGET_FG,
    COLOR_DESKTOP = 0x03,
...
enum {
    ...
    COLOR_CARD_BACK_BG_2 = COLOR_WIDGET_A_BG,
    COLOR_CARD_RED_FG = COLOR_ALERT_FG,
    COLOR_CARD_BLACK_FG = COLOR_WIDGET_FG,
    COLOR_CARD_SEL_BG = COLOR_WIDGET_A_BG,
    COLOR_CARD_SEL_FG = COLOR_WIDGET_A_FG,
